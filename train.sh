...
epochs=300
freezed_epochs=0
batch_size=12 # efficientnet -> 32 / efficientnet_pretrained_b4 -> 16
optimizer="sgd"
snapshot=1
lr=0.01 # learning_rate
path_extension="steplr_phase2_weightedLoss_CutMix"
...
python3 -u train.py --optimizer $optimizer --model_name $model --learning_rate $lr --epochs $epochs \
                    ...
                    --img_size $img_size --crop_size $crop_size --snapshot $snapshot --weighted_loss --cutmix
